...
/**
 * shash_table_get - Gets value associated
 * 	with key in sorted hash table
 * @ht: Pointer to sorted hash table
 * @key: the key to get value from
 *
 * Return: NULL - if the key cannot match
 *         The value associate with the key ht - Otherwise
 */
...
/**
 * shash_table_print_rev - Print sorted hash table in reversed order
